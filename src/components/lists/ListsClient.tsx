...
// ── List item row ──────────────────────────────
// Replace the entire ListItemRow function with this
...
function RecipeCard({
  ...
  return (
    <div className="mx-4 mb-3 bg-white dark:bg-[#1e2528] border border-[#ebebeb] dark:border-[#2e3538] rounded-[14px] overflow-hidden">
